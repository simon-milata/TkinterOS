...
from styles import desktop_colors, font_family, font_size_big, font_size_medium, font_color, button_color
...
class PyBrowse:
    ...
    def create_no_internet_gui(self) -> None:
        ...
        self.pybrowse_game = PyBrowseGame(self.WINDOW, self.game_frame)
